...
export class PDFProcessor extends BaseProcessor {
    ...
    /**
     * Process section content into timeline events
     * @private
     */
    ...
    extractParticipants(text) {
        ...
        const falsePositives = new Set([
            ...
            'Condo Sale', 'Health Insurance', 'Mortgage Payment', 'Winter Break',
            'Sound Practices', 'Parent Coordinator', 'Running List', 'Apple Cash',
            'Local Hoops', 'Capital Gains', 'Ordinary Income', 'Insurance Card',
            'Sunday Dec', 'Monday Dec', 'Tuesday Dec', 'Wednesday Dec',
            'Thursday Dec', 'Friday Dec', 'Saturday Dec', 'Next Saturday',
            'Last Thursday', 'This Saturday', 'Extra Mortgage', 'Developer Weeks',
            'Breakthrough Moment', 'Sound Practices', 'Power Back', 'Running List'
        ]);
