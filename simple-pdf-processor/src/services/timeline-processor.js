...
class TimelineProcessor {
    ...
    async processDocument(document) {
        try {
            ...
            // Handle attachments
            if (document.classification.type === 'spreadsheet' || document.classification.type === 'document') {
                const attachmentInfo = await this.copyAttachment(document.path, document.id);
